...
const slides = [
  {
    ...
    description:
      'An anonymous and secure platform to report child abuse. Your privacy matters — all reports are confidential.',
    image:
      'https://plus.unsplash.com/premium_photo-1673543757560-061f5222201c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    title: 'Confidential. Secure. Life-Saving.',
    description:
      'Help eliminate drug activity from your neighborhood. Submit tips without revealing your identity.',
    image:
      'https://images.unsplash.com/photo-1604198729707-3e29206ef963?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
...
const Slider = ({ onReportClick, onHowItWorksClick }) => {
